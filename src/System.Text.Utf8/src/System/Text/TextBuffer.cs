...
{
    //public struct TextBuffer : IEquatable<TextBuffer>, IDisposable
    //{
    //    private GCHandle _handle;

    //    public ByteSpan ByteSpan { get; private set; }

    //    public TextBuffer(ByteSpan byteSpan)
    //    {
    //        _handle = new GCHandle();
    //        ByteSpan = byteSpan;
    //    }

    //    public unsafe TextBuffer(byte[] buffer, long index, long length)
    //    {
